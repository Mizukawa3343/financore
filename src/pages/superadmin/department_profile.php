...
// include "../../api/superadmin_query.php";
...
$department = get_department_by_id($conn, $department_id);
...
<div class="section-header">
    <div class="fee-details-wrapper">
        <div class="left">
            <a href="./department.php">Back to department list</a>
...
<div class="admin-dashboard">
        ...
        <div class="card">
            <div class="card-data">
                <h2><?= $transaction_today["total_transactions_today"] ?>
                    <span><?= $transaction_today["total_revenue_today"] ?> total revenue</span>
                </h2>
    ...
    <div class="department-analytics">
        <div>
            ...
            <div>
                <canvas id="paymentTrendChart" height="350"></canvas>
            </div>
        </div>
        <div>
            <h3 class="title">
            ...
            <div>
                <canvas id="feeStatusChart" height="300"></canvas>
            </div>
        </div>
